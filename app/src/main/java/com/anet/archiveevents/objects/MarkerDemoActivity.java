...
//                .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_photo_for_report_exp))
...
//                .icon(vectorToBitmap(R.drawable.background_for_connect, Color.parseColor("#A4C639")))
//                .title("Alice Springs"));
//
